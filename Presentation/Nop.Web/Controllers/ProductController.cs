...
namespace Nop.Web.Controllers
{
    public partial class ProductController : BasePublicController
    {
        ...
        public ActionResult AddProductToCompareList(int productId)
        {
            ...
            var productsCount = _compareProductsService.AddProductToCompareList(productId);
            ...
            //var productsCount = _compareProductsService.GetComparedProductIds().Count;
            return Json(new
            {
                success = true,
                count = productsCount,
        ...
        public ActionResult HomePageReview()
        {
            var model = new List<ReviewModel>();

            var productReviews = _productService.GetAllProductReviews(0, true, null, null, null, 0, 0, 0, int.MaxValue);
            ...
            foreach (var review in productReviews)
            {
                ...
                model.Add(new ReviewModel
                {
                    ...
                    ProductSeName = review.Product.GetSeName<Product>(),
                    CustomerName = review.Customer.GetFullName(),
                    Title = review.Title,
                    ReviewText = review.ReviewText,
