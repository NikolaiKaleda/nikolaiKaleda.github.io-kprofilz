...
namespace Nop.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
	{
        ...
        public ActionResult GeneralCommon()
        {
            ...
            model.StoreInformationSettings.Phone1 = storeInformationSettings.Phone1;
            model.StoreInformationSettings.Phone2 = storeInformationSettings.Phone2;
            model.StoreInformationSettings.Address = storeInformationSettings.Address;
            model.StoreInformationSettings.Skype = storeInformationSettings.Skype;
            model.StoreInformationSettings.Email = storeInformationSettings.Email;
            ...
            if (storeScope > 0)
            {
                ...
                model.StoreInformationSettings.Skype_OverrideForStore = _settingService.SettingExists(storeInformationSettings, x => x.Skype, storeScope);
                model.StoreInformationSettings.Phone1_OverrideForStore = _settingService.SettingExists(storeInformationSettings, x => x.Phone1, storeScope);
                model.StoreInformationSettings.Phone2_OverrideForStore = _settingService.SettingExists(storeInformationSettings, x => x.Phone2, storeScope);
                model.StoreInformationSettings.Address_OverrideForStore = _settingService.SettingExists(storeInformationSettings, x => x.Address, storeScope);
                model.StoreInformationSettings.Email_OverrideForStore = _settingService.SettingExists(storeInformationSettings, x => x.Email, storeScope);
        ...
        public ActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            storeInformationSettings.Phone1 = model.StoreInformationSettings.Phone1;
            storeInformationSettings.Phone2 = model.StoreInformationSettings.Phone2;
            storeInformationSettings.Address = model.StoreInformationSettings.Address;
            storeInformationSettings.Skype = model.StoreInformationSettings.Skype;
            storeInformationSettings.Email = model.StoreInformationSettings.Email;
            //contact us
            ...
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.Skype, model.StoreInformationSettings.Skype_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.Phone1, model.StoreInformationSettings.Phone1_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.Phone2, model.StoreInformationSettings.Phone2_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.Address, model.StoreInformationSettings.Address_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.Email, model.StoreInformationSettings.Email_OverrideForStore, storeScope, false);
